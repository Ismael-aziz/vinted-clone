...
class CategoriesScreenFemmes extends StatelessWidget {
  const CategoriesScreenFemmes({Key? key}) : super(key: key);
      ...
      body: ListView(
        children: [
          ...
          ListTile(
            ...
            title: Text('Sacs'),
            onTap: () {
              // Action lors du tap sur Sacs
            },
          ),
          ListTile(
            leading: Icon(Icons.accessibility, color: Colors.teal),
